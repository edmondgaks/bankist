...
const startLogOutTimer = function() {
  const tick = function() {
    ...
    // In each call, printf the remaining time to UI
...
console.log(new Date('Tue Apr 05 2022 13:29:22'));
...
calcDaysPassed(new Date(2037,3,14), new Date(2037,3,14),new Date(2037,3,14));
console.log(days1);
...
const pizzaTimer = setTimeout((in1,in2) => {
  console.log(`Here is your pizza with ${in1} and ${in2}`);
},3000, ...ingredients);
